...
const { createFoodCriteria, getAllFoodCriteria, updateFoodCriteria, deleteFoodCriteria, FoodCriteria, getFoodCriteriaV, getAllFoodCriterias, getAllFoodCriteriaCPI} = require("../controllers/trx_food_criteriaController");
